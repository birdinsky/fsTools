========================================================================
    ACTIVE TEMPLATE LIBRARY : fsTools Project Overview
========================================================================

AppWizard has created this fsTools project for you to use as the starting point for
...
fsTools.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (fsTools.h)
        GUID definitions                                (fsTools_i.c)
        A type library                                  (fsTools.tlb)
        Marshaling code                                 (fsTools_p.c and dlldata.c)

fsTools.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in fsTools.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named fsTools.pch and a precompiled types file named StdAfx.obj.
...
fsToolsps.vcxproj
	...
	dlldata.c, fsTools_i.c and fsTools_p.c which are required
	to build the proxy/stub DLL.

fsToolsps.vcxproj.filters
